...
"""
1. Extraer el correo del primer reviewer del producto
...
print(f'El correo del primer producto es: {reviewer}')
...
print (f'El segundo tag del quinto producto es: {segundo_tag_5}')